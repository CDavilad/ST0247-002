...
public class Principal
{
    ...
    public static GrafoAM grafoDistanciaTiempo(ArrayList<Coordenadas> datos, cVehicle carrito){
    ...
    public static ArrayList<Integer> getRuta(ArrayList<Coordenadas> datos, cVehicle carrito){
    ...
    public static double calcularTiempo(ArrayList<Coordenadas> datos, cVehicle carrito, ArrayList<Integer> ruta){
