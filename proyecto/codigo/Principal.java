...
public class Principal
{
    ...
    public static void main(String[] args) throws IOException, InterruptedException{
        ...
        ArrayList<Coordenadas> datos = lectorcito.getC();
        Vehiculo carrito = lectorcito.v;
        ...
        visitados1[0] = true;
        ruta.add(0);
        grafoDistanciaTiempo(datos, carrito);
        getRuta(datos, carrito);
    ...
    public static Lector leerDatos(Lector lectorcito, String rutaA){
        lectorcito.leer("C:\\Users\\Cazadormas\\Downloads\\" + rutaA);
        return lectorcito;
    }

    public static GrafoAM grafoDistanciaTiempo(ArrayList<Coordenadas> datos, Vehiculo carrito){
    ...
    public static ArrayList<Integer> getRuta(ArrayList<Coordenadas> datos, Vehiculo carrito){
    ...
    public static double calcularTiempo(ArrayList<Coordenadas> datos, Vehiculo carrito, ArrayList<Integer> ruta){
